...
Below are some plots visualising the differential expression. 
#### MD plots
...
<!-- Below is some code for generating the plots in the paper.  -->
...
<!--   topTables_RUVk1 %>% -->
<!--     bind_rows() %>%  -->
<!--     mutate(coef = recode(coef, `R122Pfs/+` = "null/+"),  -->
<!--            coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
<!--     ggplot(aes(x = logCPM, y = logFC,  colour = DE)) + -->
<!--     geom_point( -->
<!--       alpha = 0.25 -->
<!--     ) + -->
...
<!--   common.legend = TRUE -->
<!-- ) + -->
<!--   ggsave("plots/volcano_MD_noLabs.pdf", width = 17, height = 15, units = "cm", dpi = 600) -->
<!-- ``` -->
...
<!--   spread(key = "coef", value = "logFC") %>%  -->
<!--   column_to_rownames("symbol") %>%  -->
<!--   dplyr::select(`null/+`, trans, `EOfAD-like/+`) %>%  -->
<!--   pheatmap( -->
<!--     border_color = NA, -->
<!--     scale = "row", -->
<!--     height = 5, -->
<!--     main = "KEGG_ALZHEIMERS_DISEASE", -->
<!--     fontsize = 8,  -->
<!--     width = 3, -->
<!--     cellwidth = 10,  -->
<!--     treeheight_col = 2, -->
...
<!-- ```{r} -->
<!-- png("plots/heatmaps/kegg_TCAcycle_logFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--   mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>% -->
...
<!-- ## KEGG_RIBOSOME -->
<!-- ```{r} -->
<!-- png("plots/heatmaps/KEGG_RIBOSOME_logFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>% -->
...
<!-- ```{r} -->
<!-- png("plots/heatmaps/KEGG_HUNTINGTONS_DISEASE_logFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
...
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
<!--   dplyr::filter(gene_id %in% hallmark$HALLMARK_IL2_STAT5_SIGNALING) %>%  -->
<!--   dplyr::select(symbol, logFC, coef) %>%  -->
<!--   dplyr::distinct(symbol, coef, .keep_all = TRUE) %>%  -->
<!--   spread(key = "coef", value = "logFC") %>%  -->
<!--   column_to_rownames("symbol") %>%  -->
...
<!-- ```{r} -->
<!-- png("plots/heatmaps/KEGG_PARKINSONS_DISEASE_logFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>% -->
...
<!-- ```{r} -->
<!-- png("plots/heatmaps/HALLMARK_OXIDATIVE_PHOSPHORYLATIONE_logFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>% -->
...
<!--     scale = "row", -->
<!--     height = 5, -->
<!--     main = "HALLMARK_OXIDATIVE_PHOSPHORYLATION", -->
<!--     fontsize = 8,  -->
<!--     width = 3, -->
<!--     cellwidth = 10,  -->
<!--     treeheight_col = 2, -->
...
<!-- ```{r} -->
<!-- png("plots/heatmaps/HALLMARK_MTORC1_SIGNALING_logFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>% -->
...
<!--     scale = "row", -->
<!--     height = 5, -->
<!--     main = "HALLMARK_MTORC1_SIGNALING", -->
<!--     fontsize = 8,  -->
<!--     width = 3, -->
<!--     cellwidth = 10,  -->
<!--     treeheight_col = 2, -->
...
<!-- ```{r} -->
<!-- png("plots/heatmaps/HALLMARK_MYC_TARGETS_V1_logFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>% -->
<!--   dplyr::filter(gene_id %in% hallmark$HALLMARK_MYC_TARGETS_V1) %>% -->
<!--   dplyr::select(symbol, logFC, coef) %>%  -->
<!--   dplyr::distinct(symbol, coef, .keep_all = TRUE) %>%  -->
<!--   spread(key = "coef", value = "logFC") %>%  -->
<!--   column_to_rownames("symbol") %>%  -->
...
<!-- ## KEGG_PROTEOSOME -->
<!-- ```{r} -->
<!-- png("plots/heatmaps/KEGG_PROTEASOMElogFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
<!--   dplyr::filter(gene_id %in% KEGG$KEGG_PROTEASOME) %>%  -->
<!--   dplyr::select(symbol, logFC, coef) %>%  -->
<!--   dplyr::distinct(symbol, coef, .keep_all = TRUE) %>%  -->
<!--   spread(key = "coef", value = "logFC") %>%  -->
<!--   column_to_rownames("symbol") %>%  -->
...
<!-- ## KEGG GLYCOYLSIS -->
<!-- ```{r} -->
<!-- png("plots/heatmaps/KEGG_GLYCOLYSIS_GLUCONEOGENESISlogFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
...
<!-- ## Epithelial mes. transition -->
<!-- ```{r} -->
<!-- png("plots/heatmaps/HALLMARK_EPITHELIAL_MESENCHYMAL_TRANSITIONlogFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
<!--   dplyr::filter(gene_id %in% hallmark$HALLMARK_EPITHELIAL_MESENCHYMAL_TRANSITION) %>%  -->
<!--   dplyr::select(symbol, logFC, coef) %>%  -->
<!--   dplyr::distinct(symbol, coef, .keep_all = TRUE) %>%  -->
<!--   spread(key = "coef", value = "logFC") %>%  -->
<!--   column_to_rownames("symbol") %>%  -->
...
<!--     scale = "row", -->
<!--     height = 5, -->
<!--     main = "HALLMARK_EPITHELIAL_MESENCHYMAL_TRANSITION", -->
<!--     fontsize = 8,  -->
<!--     width = 3, -->
<!--     cellwidth = 10,  -->
<!--     treeheight_col = 0, -->
...
<!-- ## APICAL JUNCTION -->
<!-- ```{r} -->
<!-- png("plots/heatmaps/HALLMARK_APICAL_JUNCTIONlogFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>% -->
<!--   dplyr::filter(gene_id %in% hallmark$HALLMARK_APICAL_JUNCTION) %>%  -->
<!--   dplyr::select(symbol, logFC, coef) %>%  -->
<!--   dplyr::distinct(symbol, coef, .keep_all = TRUE) %>%  -->
<!--   spread(key = "coef", value = "logFC") %>%  -->
<!--   column_to_rownames("symbol") %>%  -->
...
<!-- ```{r} -->
<!-- png("plots/heatmaps/KEGG_CELL_ADHESION_MOLECULES_CAMS_logFC.png", width = 5, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--    mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
<!--   dplyr::filter(gene_id %in% KEGG$KEGG_CELL_ADHESION_MOLECULES_CAMS) %>%  -->
<!--   dplyr::select(symbol, logFC, coef) %>%  -->
<!--   dplyr::distinct(symbol, coef, .keep_all = TRUE) %>%  -->
<!--   spread(key = "coef", value = "logFC") %>%  -->
<!--   column_to_rownames("symbol") %>%  -->
...
<!--     scale = "row", -->
<!--     height = 5, -->
<!--     main = "KEGG_CELL_ADHESION_MOLECULES_CAMS", -->
<!--     fontsize = 8,  -->
<!--     width = 3, -->
<!--     cellwidth = 10,  -->
<!--     treeheight_col = 0, -->
...
<!-- dev.off() -->
<!-- ``` -->
<!-- # leading edge shared genes -->

<!-- ## V1482Afs -->
<!-- ```{r} -->
<!-- leadingEdges_shared_genesV1482Afs <-  -->
<!--   fgseaRes_RUVk1_hm %>%  -->
<!--   bind_rows() %>%  -->
<!--   bind_rows(fgseaRes_RUVk1_kg %>% bind_rows()) %>%  -->
<!--   dplyr::filter(coef == "V1482Afs/+" &  -->
<!--                   pathway %in% c("KEGG_ALZHEIMERS_DISEASE", "KEGG_HUNTINGTONS_DISEASE", "KEGG_PARKINSONS_DISEASE", "KEGG_OXIDATIVE_PHOSPHORYLATION", "HALLMARK_OXIDATIVE_PHOSPHORYLATION")) %>%  -->
<!--   dplyr::select(pathway, leadingEdge) %>%  -->
<!--   unnest %>%  -->
<!--   set_colnames(c("pathway", "gene_id")) %>%  -->
<!--   as_tibble() %>%  -->
<!--   left_join(zfGeneNames) %>%  -->
<!--   left_join(topTables_RUVk1$`V1482Afs/+`, by = "gene_id") %>%  -->
<!--   dplyr::select(pathway, gene_name, logFC) %>%  -->
<!--   spread(key = "pathway", value = "logFC") %>%  -->
<!--   column_to_rownames("gene_name")  -->

<!-- png("plots/leadingEdgeSharedGenes_v1482afs.png", width = 10, height = 30, units = "cm", res = 300) -->
<!-- leadingEdges_shared_genesV1482Afs %>%  -->
<!--   pheatmap( -->
<!--     na_col = "white",  -->
<!--     cluster_cols = F, fontsize = 5, -->
<!--     cellwidth = 10, -->
<!--     cluster_rows = F,  -->
<!--     color = colorRampPalette(rev(brewer.pal(n = 7, name = -->
<!-- "RdBu")))(100)) -->
...
<!-- ```{r} -->
<!-- leadingEdges_shared_genesnull <-  -->
<!--   fgseaRes_RUVk1_hm %>%  -->
<!--   bind_rows() %>%  -->
<!--   bind_rows(fgseaRes_RUVk1_kg %>% bind_rows()) %>%  -->
<!--   dplyr::filter(coef == "trans" &  -->
<!--                   pathway %in% c("KEGG_PARKINSONS_DISEASE", "KEGG_OXIDATIVE_PHOSPHORYLATION", "HALLMARK_OXIDATIVE_PHOSPHORYLATION")) %>%  -->
<!--   dplyr::select(pathway, leadingEdge) %>%  -->
<!--   unnest %>%  -->
<!--   set_colnames(c("pathway", "gene_id")) %>%  -->
<!--   as_tibble() %>%  -->
<!--   left_join(zfGeneNames) %>%  -->
<!--   left_join(topTables_RUVk1$trans, by = "gene_id") %>%  -->
<!--   dplyr::select(pathway, gene_name, logFC) %>%  -->
<!--   spread(key = "pathway", value = "logFC") %>%  -->
<!--   column_to_rownames("gene_name")  -->

<!-- png("plots/leadingEdgeSharedGenes_null.png", width = 10, height = 30, units = "cm", res = 300) -->
<!-- leadingEdges_shared_genesnull %>%  -->
<!--   pheatmap( -->
<!--     na_col = "white",  -->
<!--     cluster_cols = F,  -->
...
<!-- ## cell type plots -->
<!-- I obtained a list of gene names which are enriched in 3 different cell types in the adut mouse brain from this paper:  -->

<!-- Lein ES, Hawrylycz MJ, Ao N, Ayres M, Bensinger A, Bernard A, et al. Genome-wide -->
<!-- atlas of gene expression in the adult mouse brain. Nature. 2007;445(7124):168-76. Epub 2006/12/06. doi: 10.1038/nature05453. PubMed PMID: 17151600. -->

<!-- I then got a list of genes for microglia using this paper:  -->

<!-- Oosterhof N, Holtman IR, Kuil LE, et al. Identification of a conserved and acute neurodegeneration-specific microglial transcriptome in the zebrafish. Glia. 2017;65(1):138–149. doi:10.1002/glia.23083 -->

<!-- Looking at the logCPM of all the genes.  -->
...
<!--     left_join(geneDGE$samples) %>%  -->
<!--     mutate(Genotype_forPub = dplyr::recode(Genotype_forPub, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
<!--     ggplot(aes(x = Genotype_forPub, y = logCPM)) + -->
<!--     geom_violin( -->
<!--       aes(fill = Genotype_forPub), -->
<!--       alpha = 0.75,  -->
<!--       trim = FALSE) + -->
...
<!-- labels = "AUTO" -->
<!-- ) + -->
<!--   ggsave("plots/celltype_heatmaps/celltype_logCPM_violin.pdf", width = 17, height = 17, units = "cm", dpi = 200) -->
<!-- ``` -->

<!-- ## GC content and length plots -->
...
<!--     bind_rows() %>%  -->
<!--     mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"),  -->
<!--            coef = dplyr::recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
...
<!-- legend = "bottom" -->
<!-- ) + -->
<!--   ggsave("plots/gc_lengthplots.pdf", width = 15, height = 15, units = "cm", dpi = 300) -->
...
<!--                   ) %>%  -->
<!--     mutate(lib.size = lib.size/1e6) %>%  -->
<!--     ggplot(aes(x = PC1, y = lib.size, colour = Genotype_forPub, shape = Sex)) + -->
<!--     geom_point(size = 4) + -->
<!--     theme_bw() + -->
<!--     labs( -->
<!--       x = "PC1 (54.55%)",  -->
...
<!--   ) %>%  -->
<!--   mutate(lib.size = lib.size/1e6) %>%  -->
<!--   ggplot(aes(x = PC1, y = W_1, colour = Genotype_forPub, shape = Sex)) + -->
<!--     geom_point(size = 4) + -->
<!--     theme_bw(), -->
<!--   pca_raw$x %>%  -->
<!--     as.data.frame() %>%  -->
...
<!--                   ) %>%  -->
<!--     mutate(lib.size = lib.size/1e6) %>%  -->
<!--     ggplot(aes(x = W_1, y = lib.size, colour = Genotype_forPub, shape = Sex)) + -->
<!--     geom_point(size = 4) + -->
<!--     theme_bw() + -->
<!--     labs( -->
<!--       x = "W_1",  -->
...
<!--   common.legend = TRUE,  -->
<!--   legend = "bottom")  + -->
<!-- ggsave("plots/PCA_all_v1.pdf", width = 18, height = 18, units = "cm", dpi = 300) -->
...
<!--       gene_set = "IRE" -->
<!--     ) %>%  -->
<!--   bind_rows(harmonic_p_HIF %>%  -->
<!--   mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"),  -->
<!--          coef = dplyr::recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
<!--   mutate( -->
<!--     pathway = case_when( -->
<!--       pathway == "GROSS_HYPOXIA_VIA_HIF1A_DN" ~ "HIF1 targets down",  -->
<!--       pathway == "GROSS_HYPOXIA_VIA_HIF1A_UP" ~ "HIF1 targets up"),  -->
<!--     gene_set = "HIF") -->
<!--   ) %>%  -->
<!--   ggplot(aes(pathway, -log10(harmonic_p), fill = sig)) + -->
<!--     geom_col() + -->
<!--     facet_grid(cols = vars(coef), rows = vars(gene_set), space = "free_y", scales = "free_y") + -->
<!--     coord_flip() + -->
<!--     labs( -->
<!--       x = "",  -->
<!--       fill = "Harmonic mean p-value\n< 0.05 after FDR adjustment?" -->
<!--     ) + -->
<!--     scale_fill_manual(values = c("grey50", "turquoise3")) + -->
<!--     theme_bw() + -->
<!--     theme( -->
...
<!--   ggsave("plots/ire_hif_harmonP.pdf", width = 20, height = 10, units = "cm", dpi = 600) -->
<!-- ``` -->
...
<!-- ncol = 2 -->
<!-- ) + -->
<!--   ggsave("plots/IRE_HIF.png", width = 22, height = 8, units = "cm", dpi = 300) -->
<!-- ``` -->

<!-- ```{r} -->
<!-- png("plots/IRE_heatmaps/3_IRE_All.png", width = 27, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--      mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
...
<!-- png("plots/IRE_heatmaps/3_HIFTargets_DN.png", width = 27, height = 7, units = "cm", res = 300) -->
<!-- topTables_RUVk1 %>%  -->
<!--   bind_rows() %>%  -->
<!--      mutate(coef = dplyr::recode(coef, `R122Pfs/+` = "null/+"), -->
<!--          coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
...
<!--     harmonic_p_FDR < 0.05 & wilk_p_FDR < 0.05 ~ "both",  -->
<!--     harmonic_p_FDR < 0.05 & wilk_p_FDR > 0.05 ~ "HMP only",  -->
<!--     harmonic_p_FDR > 0.05 & wilk_p_FDR < 0.05 ~ "wilk only",  -->
<!--     TRUE ~ "neither" -->
<!--   )) %>%  -->
<!--   ggplot(aes(-log10(harmonic_p), -log10(wilkinson_p))) + -->
<!--   geom_abline(slope = 1, linetype = 2) + -->
<!--   geom_point(aes(colour = significance), size = 3, alpha = 0.8) + -->
<!--   facet_wrap(~coef) + -->
<!--   scale_color_manual(values = c("red", "grey50")) + -->
<!--   labs(colour = "Significance after\nFDR adjustment")+ -->
<!--   theme_bw() + -->
<!--   theme(aspect.ratio = 1) + -->
<!--   ggtitle("Wilkinson p: r = 1"), -->
...
<!--            coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
<!--   mutate(significance = case_when( -->
<!--     harmonic_p_FDR < 0.05 & wilk_p_2_FDR < 0.05 ~ "both",  -->
<!--     harmonic_p_FDR < 0.05 & wilk_p_2_FDR > 0.05 ~ "HMP only",  -->
<!--     harmonic_p_FDR > 0.05 & wilk_p_2_FDR < 0.05 ~ "wilk only",  -->
<!--     TRUE ~ "neither" -->
<!--   )) %>%  -->
<!--   ggplot(aes(-log10(harmonic_p), -log10(wilkinson_p_2))) + -->
<!--   geom_abline(slope = 1, linetype = 2) + -->
<!--   geom_point(aes(colour = significance), size = 3, alpha = 0.8) + -->
<!--   facet_wrap(~coef) + -->
<!--   scale_color_manual(values = c("red", "seagreen", "grey50", "skyblue")) + -->
<!--   labs(colour = "Significance after\nFDR adjustment")+ -->
<!--   theme_bw() + -->
<!--   theme(aspect.ratio = 1) + -->
<!--   ggtitle("Wilkinson p: r = 2"), -->
...
<!--            coef = recode(coef, `V1482Afs/+` = "EOfAD-like/+")) %>%  -->
<!--   mutate(significance = case_when( -->
<!--     harmonic_p_FDR < 0.05 & wilk_p_3_FDR < 0.05 ~ "both",  -->
<!--     harmonic_p_FDR < 0.05 & wilk_p_3_FDR > 0.05 ~ "HMP only",  -->
<!--     harmonic_p_FDR > 0.05 & wilk_p_3_FDR < 0.05 ~ "wilk only",  -->
<!--     TRUE ~ "neither" -->
<!--   )) %>%  -->
<!--   ggplot(aes(-log10(harmonic_p), -log10(wilkinson_p_3))) + -->
<!--   geom_abline(slope = 1, linetype = 2) + -->
<!--   geom_point(aes(colour = significance), size = 3, alpha = 0.8) + -->
<!--   facet_wrap(~coef) + -->
<!--   scale_color_manual(values = c("red", "seagreen", "grey50", "skyblue")) + -->
...
<!-- # export data -->
<!-- ```{r} -->
<!-- saveRDS(RUV_k1, "R_objects/RUVk1.rds") -->
<!-- saveRDS(geneDGE, "R_objects/geneDGE_TMM_filteredlowly_RUVk1.rds") -->
<!-- ``` -->
